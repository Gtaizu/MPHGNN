...
parser.add_argument('-ep', '--epoch', default=10, type=int,
...
parser.add_argument('-ag', '--aggregate_type', default='BiTrans', type=str,
...
parser.add_argument('-bn', '--batch_norm', action='store_true',
                    help='The rate of dropout layer')
parser.add_argument('-sk', '--skip', default=True, type=bool,
                    help='')
parser.add_argument('-mil', '--mil', default=True, type=bool,
                    help='')
parser.add_argument('-ip', '--ins_predict', default=True, type=bool,
                    help='')
